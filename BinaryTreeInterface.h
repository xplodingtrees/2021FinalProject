...
public:
    ...
    /**
     * Replaces the data item in the root of this binary tree  with the given data, if the tree is not empty.
     * However, if the tree is empty, inserts a new root node containing the given data into the tree.
     *  @pre  None.
